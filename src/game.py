...
# --- GAME CLASS (Task B update applied) ---
class Game:
    def __init__(self):
        self.player = Player()
        self.level_colour = -1
    ...
    def next_level(self):
        ...
        self.pending_enemies = num_strong * [Robot.TYPE_AGGRESSIVE] + num_weak * [Robot.TYPE_NORMAL]
...
# Global game instance (needed for block() and others)
game = Game()
